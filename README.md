...
### Tips
- Watch for `[WARN]` about missing assets or network throttling.
- Keep large assets (models, new corpora) outside git; document download commands instead.
...
### Notas
- Los mensajes `[WARN]` indican faltantes o problemas de red; reintenta tras solucionarlos.
- Evita subir archivos pesados; usa la carpeta de exportación si quieres compartir solo una muestra.
...
### Dicas
- Monitore o terminal para alertas de dados ausentes ou limite de API.
- Mantenha assets grandes fora do repositório; documente os passos de download.
